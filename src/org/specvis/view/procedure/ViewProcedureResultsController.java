...
public class ViewProcedureResultsController implements Initializable {
    ...
    private void drawMap() {
        ...
        // Prepare dataset.
        ArrayList<ArrayList<ProcedureBasicStimulus>> dataset = functions.getSortedDataFromFromBasicProcedure();
        ...
        double maxDBValue = functions.decibelsValue(StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getStimulusMaxLuminance(), StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getStimulusMinLuminance(), StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getBackgroundLuminance(), 2);
        ...
        double distanceBetweenStimuliX = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getDistanceBetweenStimuliInDegreesX();
        double distanceBetweenStimuliY = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getDistanceBetweenStimuliInDegreesY();

        double visualFieldUsedInMapX;
        double visualFieldUsedInMapY;

        if (StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().isCorrectionForSphericityCheckBoxChecked()) {
            visualFieldUsedInMapX = functions.findRealInvolvedVisualFieldWithCorrectionForSphericity(involvedVisualFieldX, StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointLocationX(), StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getPatientDistanceFromTheScreen(), StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getScreenWidth(), distanceBetweenStimuliX);
            visualFieldUsedInMapY = functions.findRealInvolvedVisualFieldWithCorrectionForSphericity(involvedVisualFieldY, StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointLocationY(), StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getPatientDistanceFromTheScreen(), StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getScreenHeight(), distanceBetweenStimuliY);
        } else {
            visualFieldUsedInMapX = functions.findRealInvolvedVisualFieldNormal(involvedVisualFieldX, StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointLocationX(),distanceBetweenStimuliX);
            visualFieldUsedInMapY = functions.findRealInvolvedVisualFieldNormal(involvedVisualFieldY, StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointLocationY(), distanceBetweenStimuliY);
        }
        ...
        if (showAxes || showFixationPoint) {
            ...
            centerOfTheGridX = (contour2DMap.getPrefWidth() / 2) + (pixelsForOneDegreeX * StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointLocationX());
            centerOfTheGridY = (contour2DMap.getPrefHeight() / 2) + (pixelsForOneDegreeY * StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointLocationY());
        }
    ...
    private void drawFixationPoint(double centerOfTheGridX, double centerOfTheGridY, double pixelsForOneDegreeX, double pixelsForOneDegreeY) {
        ...
        switch (StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationMonitorTechnique()) {
            case "Blindspot":
                ...
                double blindspotDistanceFromFixPointX = StartApplication.getSpecvisData().getUiSettingsFixMonitorBlindspot().getBlindspotDistanceFromFixPointX();
                double blindspotDistanceFromFixPointY = StartApplication.getSpecvisData().getUiSettingsFixMonitorBlindspot().getBlindspotDistanceFromFixPointY();
