...
public class ViewStimuliDistribution extends Stage {
    ...
    public void drawElements() {
        ...
        switch (fixationMonitorTechnique) {
            ...
            case "Fixation point change":
                ...
                labelFixationPoint.setLayoutX(centerOfTheGridX - (widthForLabelFixPointAndFixMonitor / 2));
                labelFixationPoint.setLayoutY(centerOfTheGridY - (heightForLabelFixPointAndFixMonitor / 2));
                labelFixationPoint.setStyle(styleForLabelFixMonitor);
                labelFixationPoint.setAlignment(Pos.CENTER);
                displayPane.getChildren().add(labelFixationPoint);
                break;
            ...
            case "Both":
                ...
                /* Marker for "Fixation point change" */
                labelFixationPoint = new Label("F+M");
                labelFixationPoint.setMinSize(widthForLabelFixPointAndFixMonitor, heightForLabelFixPointAndFixMonitor);
                labelFixationPoint.setMaxSize(widthForLabelFixPointAndFixMonitor, heightForLabelFixPointAndFixMonitor);
                labelFixationPoint.setLayoutX(centerOfTheGridX - (widthForLabelFixPointAndFixMonitor / 2));
        ...
        if (previewLocationOfMsgAfterLossOfFixation) {
            ...
            switch (uiSettingsFixationAndOther.getFixationMonitorTechnique()) {
                case "Blindspot":
                    ...
                    msgBoxWidthInDegrees = uiSettingsFixMonitorBlindspot.getMsgBackgroundSizeX();
                    msgBoxHeightInDegrees = uiSettingsFixMonitorBlindspot.getMsgBackgroundSizeY();
                    ...
                    msgBoxLocationX = centerOfTheGridX + (uiSettingsFixMonitorBlindspot.getMsgDistanceFromFixPointX() * pixelsForOneDegreeX) - (msgBoxWidthInPixels / 2);
                    msgBoxLocationY = centerOfTheGridY + (uiSettingsFixMonitorBlindspot.getMsgDistanceFromFixPointY() * pixelsForOneDegreeY) - (msgBoxHeightInPixels / 2);
                ...
                case "Fixation point change":
                    ...
                    msgBoxWidthInDegrees = uiSettingsProcedureBasicFixPointChange.getMsgBackgroundSizeX();
                    msgBoxHeightInDegrees = uiSettingsProcedureBasicFixPointChange.getMsgBackgroundSizeY();

                    msgBoxWidthInPixels = msgBoxWidthInDegrees * pixelsForOneDegreeX;
                    msgBoxHeightInPixels = msgBoxHeightInDegrees * pixelsForOneDegreeY;

                    msgBoxLocationX = centerOfTheGridX + (uiSettingsProcedureBasicFixPointChange.getMsgDistanceFromFixPointX() * pixelsForOneDegreeX) - (msgBoxWidthInPixels / 2);
                    msgBoxLocationY = centerOfTheGridY + (uiSettingsProcedureBasicFixPointChange.getMsgDistanceFromFixPointY() * pixelsForOneDegreeY) - (msgBoxHeightInPixels / 2);
                ...
                case "Both":
                    ...
                    msgBoxWidthInDegrees = uiSettings.getMsgBackgroundSizeInDgX();
                    msgBoxHeightInDegrees = uiSettings.getMsgBackgroundSizeInDgY();

                    msgBoxWidthInPixels = msgBoxWidthInDegrees * pixelsForOneDegreeX;
                    msgBoxHeightInPixels = msgBoxHeightInDegrees * pixelsForOneDegreeY;

                    msgBoxLocationX = centerOfTheGridX + (uiSettings.getMsgDistanceFromFixPointInDgX() * pixelsForOneDegreeX) - (msgBoxWidthInPixels / 2);
                    msgBoxLocationY = centerOfTheGridY + (uiSettings.getMsgDistanceFromFixPointInDgY() * pixelsForOneDegreeY) - (msgBoxHeightInPixels / 2);
        ...
        if (previewLocationOfMsgAfterLossOfFixationWithText) {
            ...
            switch (uiSettingsFixationAndOther.getFixationMonitorTechnique()) {
                case "Blindspot":
                    ...
                    msgBox.setText(uiSettingsFixMonitorBlindspot.getTextOfTheMsg());
                    ...
                    backgroundColor = StartApplication.getFunctions().toHexCode(uiSettingsFixMonitorBlindspot.getMsgBackgroundColor());
                    fontColor = StartApplication.getFunctions().toHexCode(uiSettingsFixMonitorBlindspot.getFontColor());
                    fontWeight = uiSettingsFixMonitorBlindspot.getFontWeight();
                    fontSize = uiSettingsFixMonitorBlindspot.getFontSize();
                ...
                case "Fixation point change":
                    ...
                    msgBox.setText(uiSettingsProcedureBasicFixPointChange.getTextOfTheMsg());
                    msgBox.setMinSize(msgBoxWidthInPixels, msgBoxHeightInPixels);
                    msgBox.setMaxSize(msgBoxWidthInPixels, msgBoxHeightInPixels);
                    msgBox.setLayoutX(msgBoxLocationX);
                    msgBox.setLayoutY(msgBoxLocationY);

                    backgroundColor = StartApplication.getFunctions().toHexCode(uiSettingsProcedureBasicFixPointChange.getMsgBackgroundColor());
                    fontColor = StartApplication.getFunctions().toHexCode(uiSettingsProcedureBasicFixPointChange.getFontColor());
                    fontWeight = uiSettingsProcedureBasicFixPointChange.getFontWeight();
                    fontSize = uiSettingsProcedureBasicFixPointChange.getFontSize();
                ...
                case "Both":
                    ...
                    msgBox.setText(uiSettings.getTextOfTheMsg());
                    msgBox.setMinSize(msgBoxWidthInPixels, msgBoxHeightInPixels);
                    msgBox.setMaxSize(msgBoxWidthInPixels, msgBoxHeightInPixels);
                    msgBox.setLayoutX(msgBoxLocationX);
                    msgBox.setLayoutY(msgBoxLocationY);

                    backgroundColor = StartApplication.getFunctions().toHexCode(uiSettings.getMsgBackgroundColor());
                    fontColor = StartApplication.getFunctions().toHexCode(uiSettings.getFontColor());
                    fontWeight = uiSettings.getFontWeight();
                    fontSize = uiSettings.getFontSize();
