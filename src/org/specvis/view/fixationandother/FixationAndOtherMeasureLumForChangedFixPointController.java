...
public class FixationAndOtherMeasureLumForChangedFixPointController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        fixationAndOtherMonitorSettingsFixPointChange = StartApplication.getSpecvisData().getFixationAndOtherMonitorSettingsFixPointChange();
    ...
    private void setBackgroundColorOfPanePreview() {
        ...
        Color color = fixationAndOtherMonitorSettingsFixPointChange.getChangedFixPointColor();
    ...
    private void setOnActionSaveButton() throws IOException {
        ...
        fixationAndOtherMonitorSettingsFixPointChange.setChangedFixPointLuminance(rounded);
        ...
        StartApplication.getFixationAndOtherMonitorSettingsFixPointChangeController().updateValueForTextFieldChangedFixPointLuminance();
