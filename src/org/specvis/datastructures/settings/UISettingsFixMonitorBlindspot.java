...
public class UISettingsFixMonitorBlindspot {
    ...
    public void setDefaultValues() {
        ...
        fixationMonitorStimulusSizeX = 0.5;
        fixationMonitorStimulusSizeY = 0.5;
        fixationMonitorStimulusBrightness = 100;
        fixationMonitorStimulusLuminance = StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getStimulusLuminanceScale().getFittedLuminanceForEachBrightnessValue()[100];
