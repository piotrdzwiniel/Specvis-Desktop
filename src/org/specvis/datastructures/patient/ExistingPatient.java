...
public class ExistingPatient {
    ...
    public ExistingPatient(String id, String firstName, String lastName, String gender, LocalDate dateOfBirth, int age, String phone, String email, String city) {
        this.id = id;
    ...
    public static String[] getFieldsNames() {
        Field[] fields = ExistingPatient.class.getDeclaredFields();
