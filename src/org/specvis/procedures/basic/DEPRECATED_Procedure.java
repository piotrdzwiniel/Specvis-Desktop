...
public class DEPRECATED_Procedure extends Stage {
    ...
    /* Fields from UISettingsStimulusAndBackground */
    ...
    /* Fields from UISettingsFixationAndOther */
    ...
    /* Fields from UISettingsFixationAndOther -> fixation monitor "blindspot" */
    ...
    /* Fields from UISettingsFixationAndOther -> fixation monitor "fixation point change" */
    ...
    private ArrayList<ProcedureBasicStimulus> stimuliList;
    ...
    public DEPRECATED_Procedure() {
        ...
        /* Fields from StartApplication */
        chosenScreenIndex = StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getChosenScreenIndex();
        screenResolutionX = StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getScreenResolutionX();
        screenResolutionY = StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getScreenResolutionY();
        ...
        involvedVisualFieldX = StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getInvolvedVisualFieldX();
        involvedVisualFieldY = StartApplication.getSpecvisData().getUiSettingsScreenAndLuminanceScale().getInvolvedVisualFieldY();
        ...
        /* Fields from UISettingsStimulusAndBackground */
        stimulusMaxBrightness = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getStimulusMaxBrightness();
        stimulusMinBrightness = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getStimulusMinBrightness();
        stimulusShape = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getStimulusShape();
        stimulusSizeInDegreesX = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getStimulusSizeX();
        stimulusSizeInDegreesY = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getStimulusSizeY();
        stimulusInclination = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getStimulusInclination();
        stimulusDisplayTime = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getStimulusDisplayTime();
        interStimuliIntervalConstantPart = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getConstantPartOfInterval();
        interStimuliIntervalRandomPart = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getRandomPartOfInterval();
        backgroundBrightness = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getBackgroundBrightness();
        distanceBetweenStimuliInDegreesX = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getDistanceBetweenStimuliInDegreesX();
        distanceBetweenStimuliInDegreesY = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().getDistanceBetweenStimuliInDegreesY();
        isCorrectionForSphericityCheckBoxChecked = StartApplication.getSpecvisData().getUiSettingsStimulusAndBackground().isCorrectionForSphericityCheckBoxChecked();

        /* Fields from UISettingsFixationAndOther */
        fixationPointColor = StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointColor();
        fixationPointSizeX = StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointSizeX();
        fixationPointSizeY = StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointSizeY();
        fixationMonitorTechnique = StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationMonitorTechnique();
        fixationPointLocationX = StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointLocationX();
        fixationPointLocationY = StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getFixationPointLocationY();
        keyAnswerToStimulus = StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getAnswerToStimulus();
        keyPauseProcedure = StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getPauseProcedure();
        keyCancelProcedure = StartApplication.getSpecvisData().getUiSettingsFixationAndOther().getCancelProcedure();

        /* Fields from UISettingsFixationAndOther -> fixation monitor "blindspot" */
        if (fixationMonitorTechnique.equals("Blindspot")) {
            UISettingsFixMonitorBlindspot faomsb = StartApplication.getSpecvisData().getUiSettingsFixMonitorBlindspot();
        ...
        if (fixationMonitorTechnique.equals("Fixation point change")) {
            UISettingsFixMonitorFixPointChange faomsfpc = StartApplication.getSpecvisData().getUiSettingsProcedureBasicFixPointChange();
        ...
        /* Local fields -> displaying stimuli and writing answers */
        spreadValuesLogarithmically = StartApplication.getSpecvisData().getUiSettingsProcedureBasic().isSpreadValuesLogarithmically();
        visualFieldTestBrightnessVectorLength = StartApplication.getSpecvisData().getUiSettingsProcedureBasic().getVisualFieldTestBrightnessVectorLength();
        ...
        activeStimuliIndices.addAll(stimuliList.stream().map(ProcedureBasicStimulus::getIndex).collect(Collectors.toList()));
...
//                    );
    ...
    private ProcedureBasicStimulus initializeStimulus(int stimulusIndexIterator, double tempLocationX, double tempLocationY, double[] correctedStimulusSizeInPixelsXY) {

        ProcedureBasicStimulus procedureBasicStimulus = new ProcedureBasicStimulus();
        procedureBasicStimulus.setIndex(stimulusIndexIterator);
        procedureBasicStimulus.setPositionOnTheScreenInPixelsX(tempLocationX);
        procedureBasicStimulus.setPositionOnTheScreenInPixelsY(tempLocationY);
        procedureBasicStimulus.setDistanceFromFixPointOnTheFieldOfViewInDegreesX((tempLocationX - centerOfTheGridInPixelsX) / pixelsForOneDegreeX);
        procedureBasicStimulus.setDistanceFromFixPointOnTheFieldOfViewInDegreesY((tempLocationY - centerOfTheGridInPixelsY) / pixelsForOneDegreeY);

        switch (stimulusShape) {
            case "Ellipse":
                procedureBasicStimulus.setShape(createEllipseStimulus(tempLocationX, tempLocationY, correctedStimulusSizeInPixelsXY));
                break;
            case "Polygon":
                procedureBasicStimulus.setShape(createPolygonStimulus(tempLocationX, tempLocationY, correctedStimulusSizeInPixelsXY));
                break;
        }
        procedureBasicStimulus.setDisplayTime(stimulusDisplayTime);
        ...
        procedureBasicStimulus.setAnswers(new int[lengthOfVectorForAnswersToStimulus]);
        for (int i = 0; i < procedureBasicStimulus.getAnswers().length; i++) {
            procedureBasicStimulus.getAnswers()[i] = 0;
        }

        procedureBasicStimulus.setBrightnessThreshold(0);
        procedureBasicStimulus.setLuminanceThreshold(0);
        procedureBasicStimulus.setDecibelThreshold(0);

        return procedureBasicStimulus;
    }
                ...
                case "Blindspot":
                    if (b_isShowPatientMsgSelected) {
                        if (!permissionToAnswer) {
                            ...
                            viewProcedurePreviewController.setColorForCircle(Color.web("#FFAA00"));
                            viewProcedurePreviewController.setTextForLabel("Fix loss");
        ...
        if (deactivateThisStimulus) {
            ...
            if (activeStimuliIndices.size() == 0) {
                ...
                if (!fixationMonitorTechnique.equals("None")) {
                    ...
                    viewProcedurePreviewController.addTextToTextArea("Total fixation monitor checks: " + totalFixationMonitorChecks + "\n");
                    viewProcedurePreviewController.addTextToTextArea("Positive fixation monitor checks: " + positiveFixationMonitorChecks + "\n");
                    viewProcedurePreviewController.addTextToTextArea("Fixation monitor accuracy (%): " + fixationMonitorAccuracyInPercentages + "\n\n");
                }
                ...
                procedureBasicData.setArrayListProcedureBasicStimulus(stimuliList);

                procedureBasicData.setTotalFixationMonitorChecks(totalFixationMonitorChecks);
                procedureBasicData.setPositiveFixationMonitorChecks(positiveFixationMonitorChecks);
                procedureBasicData.setFixationMonitorAccuracyInPercentages(fixationMonitorAccuracyInPercentages);
